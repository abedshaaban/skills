...
| [`google-search-console`](skills/google-search-console/) | **Search Console analytics and indexing diagnostics.** Query properties, performance, and sitemaps; inspect individual URLs, URL files, or sitemaps; and check live page indexing signals through one read-only dispatcher. |
